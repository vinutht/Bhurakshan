		...
		<header>
			<div id="header">
				...
				<section class="section_title">
					<div class="inner">
						<div class="block_title"><h1>Features</h1></div>
						
						<div class="block_breadcrumbs">
							<p><a href=".">Home</a> / <span>Features</span></p>
						</div>
						...
						<div class="separator" style="height:37px;"></div>
							...
							<div class="block_about">
								<div class="main">
									...
									<p class="text_subtitle_2">Features & Benefits of our services - </p>
									<ul class="list_1">
										<li><b>Flexible Subscription Packages -</b> Customizable Packages. Include monthly/quarterly</li>
										<li><b>Easy-to-use Portal -</b> Portal with login-credentials to see and verify photographs </li>
										<li><b>Google Map -</b> Google enabled property location tracking system </li>
									</ul></br>
									<p class="text_subtitle_2">Technology features -</p>
									<p>Our Monitoring Service is backed with technology (GPS and Glonass) to locate exact location. 
 Each photo of the property is embedded with latitude and longitude information along with date and time from the GPS satellites. 
</p>
								</div>
