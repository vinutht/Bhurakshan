		...
		<header>
			<div id="header">
				...
				<section class="section_title">
					<div class="inner">
						<div class="block_title"><h1>Pricing</h1></div>
						
						<div class="block_breadcrumbs">
							<p><a href=".">Home</a> / <span>Pricing</span></p>
						</div>
					...
					<div class="main_content">
						<div class="separator" style="height:37px;"></div>
							...
							<div class="block_about">
								<div class="main">																
									<h5> For people residing in India:</h5>
									<ul class="list_1">
								<li><b>Yearly visit</b>      : INR 799 per annum</li>
								<li><b>Half Yearly visit</b> : INR 1499 per annum</li>							
								<li><b>Quarterly visit</b>   : INR 2499 per annum</li>
								<li><b>Monthly visit</b>     : INR 5999 per annum</li>									
									</ul></br>
									<h5> For people residing out of India:</h5>
									<ul class="list_1">
								...
								<li>Monthly visit     : 119 USD per annum</li>
									...
									<p>  If you have more than one property to monitor, call us for good discounts.
    If you have a group of properties(belonging to you or your friends/relatives) at one single location(area), to be monitored, call us for group discount.</p>
									<h5>Refund policy</h5>
									<p>Refunds are made available to clients only after the approval of the board at BhuRakshan. There will be no questions asked to the decision of the client.</p></br>
									<h5>Terms for refund include</h5>
									<ul class="list_1">
										<li><b>If client stops taking service during First Quarter</b> 75% will be refunded</li>
										<li><b>If client stops taking service during Second Quarter</b> 50% will be refunded</li>
										<li><b>If client stops taking service during Third Quarter</b> 25% will be refunded</li>
									</ul>	
								</div>
								<div class="block_title"><a id="ref"><h1>Earn while you Secure your Property</h1></a></div>
								<div class="main">
									
									<p>At Bhurakshan we value our registered customers. Value is showcased not just through the service but also through an earning opportunity. Refer your friend/colleague/family member to avail our service and earn money. The same money can be redeemed while you add your other property / renew your services. 
									</p>
									<p>Indian Registered Members  -  Rs.200 will be credited to your account when each of your referral subscribes for a service.
	Foreign Registered Members - $5 will be credited to your account when each of your referral subscribes for a service. </p>
									<p>How to redeem earned referral money?  </p></br>
									<p>A registered user of Bhurakshan can earn money by referring others to avail our services. The same money can be redeemed while adding other property for our services/renewing the subscription of the already added property.      </p>											
									<p>Note - one can redeem earned money only to the 50% value of the cost of the next purchase. </p>
